...
std::vector<GLfloat> Mesh3DTriangle::mPopulateAdditionalVertexData(
...
void Mesh3DTriangle::mPrintVertexData() {
    std::cout << "\nFULL VERTEX DATA: " << "\n";
...
void Mesh3DTriangle::mPrintIndexData() {
    std::cout << "\nFULL INDEX DATA: " << "\n";
...
void Mesh3DTriangle::mDrawMesh3D(GLuint shader) {
    glUseProgram(shader);
