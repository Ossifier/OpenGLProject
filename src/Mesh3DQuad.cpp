...
std::vector<GLfloat> Mesh3DQuad::mPopulateAdditionalVertexData(
...
void Mesh3DQuad::mPrintVertexData() {
    std::cout << "\nFULL VERTEX DATA: " << "\n";
...
void Mesh3DQuad::mPrintIndexData() {
    std::cout << "\nFULL INDEX DATA: " << "\n";
...
void Mesh3DQuad::mDrawMesh3D(GLuint shader) {
    glUseProgram(shader);
