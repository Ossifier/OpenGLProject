...
std::vector<GLfloat> Mesh3DCube::mPopulateAdditionalVertexData(
...
void Mesh3DCube::mPrintVertexData() {
    std::cout << "\nFULL VERTEX DATA: " << "\n";
...
void Mesh3DCube::mPrintIndexData() {
    std::cout << "\nFULL INDEX DATA: " << "\n";
...
void Mesh3DCube::mDrawMesh3D(GLuint shader) {
    glUseProgram(shader);
